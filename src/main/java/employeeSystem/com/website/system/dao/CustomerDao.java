...
public interface CustomerDao {
	...
	/**
	 * @param customer
	 * @throws Exception 將此筆TbCustomer customer存入資料庫
	 */
	 ...
	 * @param id
	 * @return
	 * @throws Exception 取出TbCustomer內符合id的資料若無則回傳null
	 */
	public TbCustomer findById(Integer id) throws Exception;

	/**
	 * @param customer
	 * @throws Exception 將符合此筆TbCustomer customer的資料從資料庫刪除
	 */
	 ...
	 * @param account
	 * @return
	 * @throws Exception 取出TbCustomer內status為signed的資料或是同時符合creator是account與status不等於delete的資料
	 */
	public List<TbCustomer> getVisibleList(String account) throws Exception;

	/**
	 * @return
	 * @throws Exception 取出TbCustomer內未簽核的資料數量
	 */
	 ...
	 * @param status
	 * @return
	 * @throws Exception 取出TbCustomer內不等於status的資料
	 */
