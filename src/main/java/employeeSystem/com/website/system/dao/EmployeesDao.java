...
public interface EmployeesDao {
	 ...
	 * @return
	 * @throws Exception
	 * 可以依entity內的各個key值找出TbEmployees內符合的資料
	 */
	 ...
	 * @return
	 * @throws Exception
	 * 取出TbEmployees內username符合name的資料
	 */
	 ...
	 * @return
	 * @throws Exception
	 * 取出TbEmployees內departmentId符合ids且可依entity內的key值做額外判斷
	 */
	 ...
	 * @param object
	 * @throws Exception
	 * 將符合此筆TbEmployees object的資料從資料庫刪除
	 */
	 ...
	 * @return
	 * @throws Exception
	 * 取出TbEmployees內username不等於account並且departmentId為15的資料
	 */
