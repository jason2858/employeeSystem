...
public interface PreferenceDao {
	...
	/**
	 * @param object
	 * @throws Exception 將此筆TbPreference object存入資料庫
	 */
	public void save(TbPreference object) throws Exception;

	/**
	 * @param object
	 * @throws Exception 將符合TbPreference object的資料從資料庫中刪除
	 */
	 ...
	 * @param key
	 * @return
	 * @throws Exception 取出TbPreference中username符合user且config_key符合key的資料，若無則回傳null
	 */
	 ...
	 * @param user
	 * @return
	 * @throws Exception 取出TbPreference中username符合user的資料，若無則回傳null
	 */
