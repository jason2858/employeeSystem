...
public interface DepartmentDao {
	/**
	 * @param department
	 * @throws Exception 將此筆TbDepartment department存入資料庫
	 */
	 ...
	 * @param authorise
	 * @param manager
	 * @throws Exception 修改TbEmployees內username符合manager的group_id為authorise
	 */
	public void updateAuthorise(String authorise, String manager) throws Exception;

	/**
	 * @param department
	 * @throws Exception 將符合此筆TbDepartment department的資料從資料庫刪除
	 */
	public void delete(TbDepartment department) throws Exception;

	/**
	 * @return
	 * @throws Exception 取出TbDepartment內所有資料
	 */
	 ...
	 * @param id
	 * @return
	 * @throws Exception 取出符合id的TbDepartment資料
	 */
	 ...
	 * @param ids
	 * @return
	 * @throws Exception 取出TbDepartment內符合ids的資料
	 */
	 ...
	 * @param account
	 * @return
	 * @throws Exception 取出TbDepartment內manager符合account的資料
	 */
	 ...
	 * @param id
	 * @return
	 * @throws Exception 取出TbDepartment內companyId符合id的資料
	 */
