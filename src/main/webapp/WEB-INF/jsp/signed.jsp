...
<script type="text/javascript">
	...
	function attDetail(record) {
		...
		if (record["formNo"].length > 0) {
			$("#formNoDiv").show();
			$("#attFormNo").html(record["formNo"]);
		} else {
			$("#formNoDiv").hide();
		}
...
<body class="fixed-nav sticky-footer" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<div class="container-fluid">
				<div class="card mb-3">
					<div class="card-header">已簽核補打卡記錄</div>
					<div class="card-body">
						<div class="table-responsive">
							...
							<span class="short_label" style="margin-left: 2%;">檢視月份 :
								<select id='makeupyear' style="width: 5rem;">
									...
									%>
							</select> 年 <select id='makeupmonth' style="width: 5rem;">
									<%
										for (int i = 1; i <= 12; i++) {
									%>
			...
			<div class="container-fluid">
				<div class="card mb-3">
					<div class="card-header">已簽核差勤記錄</div>
					<div class="card-body">
						<div class="table-responsive">
							<span class="short_label" style="margin-left: 2%;">檢視月份 :
								<select id='attyear' style="width: 5rem;">
									...
									%>
							</select> 年 <select id='attmonth' style="width: 5rem;">
									<%
										for (int i = 1; i <= 12; i++) {
									%>
									<option value='<% if(i<10){
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="MakeUpLabel">補打卡簽核明細</h5>
				...
				<div class="modal-body">
					...
					<p style="padding-top: 1%;">
						<span class="short_label"
							style="text-align: right; width: 30%; display: block; vetical-align: top; float: left;">簽核日期
							: </span><span class="short_text" style="margin-left: 3%;"
	...
	<div class="modal fade" id="attDetail" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="MakeUpLabel">差勤簽核明細</h5>
					<button class="close" id="closeUandD" type="button"
						data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
