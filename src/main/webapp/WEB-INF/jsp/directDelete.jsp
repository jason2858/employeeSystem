...
<script type="text/javascript">
  		$(document).ready(function () {
  			var code = "${code}";
	  			$.ajax({
					type:'post',
					url:"/rest/directDelete/getStatus",
					datatype:'json',
					data:{code : code},
					...
					error:function(){ 
						...
						document.getElementById("content").innerHTML = "刪除失敗!!";
					} 
				});
  			});
	...
	<div class="container"
		...
		<div class="card card-login mx-auto mt-5"
			...
			<div class="card-header" id="content"
				style="text-align: center; background-color:#F5F5DC;"></div><br>
				<a style="text-align: center;" href="/">返回登入頁面</a>
		</div>
	</div>
